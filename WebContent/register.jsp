			...
			<div class="mainin">
				<div class="mainin1">
					<ul>
						<li>
							<span>用户名：</span>
							<input name="user_name" type="text" id="user_name" onblur="checkCode()" class="SearchKeyword"/>
							<span id="userNameSpan" style="FONT-WEIGHT: bold; COLOR: red"></span>
						</li>
						<li>
							<span>密码：</span>
							<input type="password" name="user_password" id="user_password" class="SearchKeyword2"/>
